...
const PublishComment: FC = () => {
	...
	async function handleSubmit(e) {
		...
		console.log('EncryptedComment', encryptedComment)
		const commentWithLink = `${encryptedComment} This comment was encrypted. You can decrypt it here: https://some-url.xyz`
	...
	return (
		<div className="mt-8 space-y-8 divide-y divide-gray-200 border-style border-1 bg-white overflow-hidden shadow sm:rounded-lg">
			<form onSubmit={handleSubmit} className="">
				...
				<div className="flex flex-col center-items">
					<input
						...
						name="comment"
						type="text"
						placeholder="Tell something cool and... private!"
						className="block w-full h-24 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border border-gray-300 rounded-md"
						required
						value={comment}
